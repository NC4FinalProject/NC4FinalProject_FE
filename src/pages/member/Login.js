        ...
        <Container component="main" maxWidth="xs" style={{ marginTop: '6%', marginBottom:'10%' }}>
            <form onSubmit={handleSubmit}>
                <Grid container style={{justifyContent:'center', marginBottom:'3%'}}>
                    <Grid item>
                        <img src='/images/team_logo.png' alt='team_logo' style={{width: '250px', height: '50px', justifyContent:'center', display:'flex'}}></img>
                    </Grid>
                </Grid>
                ...
                <Grid container justifyContent="center" display='flex' alignItems='center'>
                    <Grid item style={{marginTop:'8%', color:'#abb0b5', width: '100%', textAlign: 'center'}}>
                        ...
                        <Typography component="span" variant='string' style={{color:'#abb0b5', zIndex: '1', position: 'relative', top: 0, backgroundColor: '#fff', padding:'0 8px' }}>
                            간편 로그인
                        </Typography>
                    </Grid> 
