...
import Codialog from "../../components/organisms/common/Codialog";
...
const Home = () => {
  ...
  const handleNext = () => {
    setSlideIndex((prev) =>
      prev < totalSlides - slidesToShow ? prev + slidesToShow : prev
    );
  };
  ...
  return (
    <div>
        ...
        >
          ...
          <ArrowForwardIosIcon
            style={{
              ...
              marginTop: "1px",
              color:
                slideIndex === totalSlides - slidesToShow ? "gray" : "black",
            }}
            onClick={handleNext}
          />
          더보기+
      ...
      <Grid item sx={{ display: "-webkit-box", overflow: "hidden" }}>
        {[
          { img: "images/google_login.png" },
          { img: "images/google_login.png" },
          { img: "images/google_login.png" },
          { img: "images/google_login.png" },
          { img: "images/kakao_login.png" },
          { img: "images/kakao_login.png" },
          { img: "images/kakao_login.png" },
          { img: "images/kakao_login.png" },
          ...
          return parseInt(index / 4) * 4 === slideIndex ? (
            <div style={{ display: "block", position: "relative" }}>
              ...
              >
                ...
                />
                <BookmarkBorderIcon
                  style={{ position: "absolute", top: "5px", right: "27px" }}
                />
              </Paper>
              <CoTypography style={{ marginTop: "5px" }}>
                프론트 리액트 1시간만에 마스터하기
              </CoTypography>
              <CoTypography size="Content" style={{ color: "#7d7d7d" }}>
                프론트앤드 | 손우성
              </CoTypography>
      ...
      <Grid container spacing={2} style={{ marginTop: "0.725rem" }}>
        ...
        >
          <CoTypography style={{ fontSize: "3rem" }}>
            NC4 FINAL을 통해 연결되는 IT, 당신의 열정을 응원합니다.
          </CoTypography>
          <CoTypography>
            학교에서 배우기 어렵거나 큰 비용을 지불해야만 배울 수 있는 전문적인
            지식들을 제공합니다. 오픈 플랫폼의 이점을 통해 다양성과 경제성을
            모두 높입니다.
          </CoTypography>
        </Grid>
        <Grid item xs={6}>
      ...
      <Codialog open={open} handleClose={handleClose} />
    </div>
  );
};
