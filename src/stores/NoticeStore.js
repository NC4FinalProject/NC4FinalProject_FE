...
const useStore = create((set, get) => ({
    ...
    fetchNotices: async () => {
      ...
      try {
        const response = await axios.get('http://175.45.203.117:9090/notice/notice-list', {
          params: {
    ...
    handleNoticeSubmit: async () => {
      ...
      try {
        ...
        await axios.post('http://175.45.203.117:9090/notice/notice', formData);
    ...
    handleNoticeModifySubmit: async (putNoticeId) => {
      ...
      try {
       ...
       const response = await axios.put('http://175.45.203.117:9090/notice/update', formData);
    ...
    noticeModifyProc: async (putNoticeId) => {
      ...
      try {
       ...
       const response = await axios.put('http://175.45.203.117:9090/notice/updateProc', formData);
    ...
    getNotice: async (noticeId) => {
      ...
      try {
        const response = await axios.get(`http://175.45.203.117:9090/notice/notice/${noticeId}`,{
